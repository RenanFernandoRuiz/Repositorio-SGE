...
namespace SGE.Controllers
{
    public class OcorrenciasController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Responder(Guid id, [Bind("OcorrenciaId,TipoOcorrenciaId,UsuarioId,DataOcorrencia,Descricao,CadAtivo,CadInativo,Finalizado,DataFinalizado,AlunoId,Tratativa")] Ocorrencia ocorrencia, string AlunoNome, string UsuarioNome)
        {
            if (id == null)
            {
                return NotFound();
